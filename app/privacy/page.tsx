        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              PersX.ai ("we", "our", or "us") is committed to protecting your privacy. This Privacy
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <div>
                ...
                <p>
                  When you use our roadmap generator or contact form, we collect information you
                  voluntarily provide, including:
                </p>
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                  <li>Name and email address</li>
                  <li>Industry and business goals</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1 text-gray-600 dark:text-gray-400">
              <li>Generate personalized experience optimization roadmaps</li>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Email:</strong> persx@alexdesigns.com
                <br />
                <strong>Support:</strong> support@persx.ai
              </p>
            </div>
          </section>
        </div>

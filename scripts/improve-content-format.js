...
// Improved content with special formatting for callout boxes
const improvedContent = `#### Feature articles and insights:

**[Kameleoon AI Copilot](https://www.kameleoon.com/blog/kameleoon-ai-copilot-changes-how-teams-experiment)**

[www.kameleoon.com](https://www.kameleoon.com/blog/kameleoon-ai-copilot-changes-how-teams-experiment)
...
**[Quantum Metric Digital Analytics](https://www.quantummetric.com/press-releases/quantum-metric-wins-isg-software-AI-innovation-award)**

[www.quantummetric.com](https://www.quantummetric.com/press-releases/quantum-metric-wins-isg-software-AI-innovation-award)
...
**[AB Tasty One Platform](https://www.abtasty.com/news/ab-tasty-announces-one-platform/)**

[www.abtasty.com](https://www.abtasty.com/news/ab-tasty-announces-one-platform/)
...
[www.optimizely.com](https://www.optimizely.com/ai/)
...
async function improveFormat() {
  const slug = 'ai-for-experimentation-emerging-trends';

  console.log('📝 Improving content format...\n');
  console.log('Changes:');
  console.log('  ✓ URLs moved to separate lines');
  console.log('  ✓ Quick Win sections converted to blockquotes (will be green)');
  console.log('  ✓ PersX.ai Perspective sections converted to blockquotes (will be purple)');
  console.log('  ✓ Quote sections converted to blockquotes (will have dark gray background)');
  console.log('');
  ...
  console.log('✅ Content format improved!\n');
  console.log('Next: Update ContentBody.tsx to style blockquotes based on their content');
  console.log('\n🌐 View at: http://localhost:3000/news/' + slug);
}

improveFormat().catch(console.error);

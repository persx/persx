...
// Content with H4 instead of H2 (## changed to ####)
const contentWithH4 = `#### Feature articles and insights:
...
async function changeH2toH4() {
  const slug = 'ai-for-experimentation-emerging-trends';

  console.log('📝 Changing H2 (##) headings to H4 (####)...\n');

  const { data, error } = await supabase
    .from('knowledge_base_content')
    .update({
      content: contentWithH4,
  ...
  console.log('✅ Headings changed to H4!\n');
  console.log('Changes:');
  console.log('─'.repeat(80));
  console.log('Before: ## Feature articles and insights:');
  console.log('After:  #### Feature articles and insights:');
  console.log('');
  console.log('Before: ## Additional Insights and Considerations');
  console.log('After:  #### Additional Insights and Considerations');
  console.log('─'.repeat(80));
  console.log('\nNow updating ContentBody.tsx to make H4 same size as H2...');
}

changeH2toH4().catch(console.error);

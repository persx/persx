...
const contentWithLinks = `## Feature articles and insights:
...
async function addClickableLinks() {
  const slug = 'ai-for-experimentation-emerging-trends';

  console.log('📝 Adding clickable links to vendor names and URLs...\n');
  ...
  console.log('✅ Clickable links added!\n');
  console.log('Now vendor names and URLs are hyperlinked:');
  console.log('─'.repeat(80));
  console.log('**[Kameleoon AI Copilot](https://www.kameleoon.com/blog/...)');
  console.log('[www.kameleoon.com](https://www.kameleoon.com/blog/...)');
  console.log('─'.repeat(80));
  console.log('\n🌐 View at: http://localhost:3000/news/' + slug);
}

addClickableLinks().catch(console.error);
